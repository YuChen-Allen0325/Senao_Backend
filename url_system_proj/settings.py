"""
Django settings for url_system_proj project.
...
SECRET_KEY = 'django-insecure-#h*x6vz1a%z%)4ed)x-8yypx#8@meld(o8(tv+ay+r9z5)$2r#'
...
WSGI_APPLICATION = 'url_system_proj.wsgi.application'
